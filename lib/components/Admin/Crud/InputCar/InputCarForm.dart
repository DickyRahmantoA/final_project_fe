...
class FormInputCar extends StatefulWidget {
  @override
  _FormInputCar createState() => _FormInputCar();
}

class _FormInputCar extends State<FormInputCar> {
          ...
          DefaultButtonCustomeColor(
            ...
            press: () {
              if (txtName.text == '') {
                ...
                inputDataCar(txtName.text, txtQty.text, txtCategoryId.text,
  ...
  void inputDataCar(name, qty, categoryId, url, createdBy, updatedBy) async {
    utilsApps.showDialog(context);
    bool status;
    var message;
    try {
      response = await dio.post(
        'http://192.168.200.21:3000/products/add',
        data: {
          'name': name,
          'qty': qty,
